...
//};
//
//#define UACCE_CMD_PIN		_IOW('W', 0, struct uacce_pin_address)
//#define UACCE_CMD_UNPIN		_IOW('W', 1, struct uacce_pin_address)
#include "../pin.h"
int write_done = 0;
char *p;
...
int main()
{
	...
	fd = open("/dev/page_pin_test", O_RDWR);
...
//riscv64-linux-gnu-gcc -lpthread --static
