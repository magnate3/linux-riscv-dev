...
def process_packet(packet):
    ...
    if 0x3a == ip6.nh:
        if packet.haslayer(ICMPv6EchoRequest):
            ...
            print("no frag, Echo request, src: ", packet[IPv6].src, "dst: ", packet[IPv6].dst,"seq: ", icmpv6.seq)
        elif packet.haslayer(ICMPv6EchoReply):
            icmpv6 = packet.getlayer(ICMPv6EchoReply)
            print("no frag, Echo reply , src: ", packet[IPv6].src, "dst: ", packet[IPv6].dst,"seq: ", icmpv6.seq)
            ...
            print("advert, src: ", packet[IPv6].src, "dst: ", packet[IPv6].dst,"type: ", packet[ICMPv6ND_NA].type, "tgt: ",  packet[ICMPv6ND_NA].tgt\
                   , "src mac: ", packet[Ether].src, "dst mac:", packet[Ether].dst)
        ...
        if 0x3a == frag.nh  and  0 == frag.offset:
            ...
            if payload.haslayer(ICMPv6EchoRequest):
                ...
                icmpv6 = packet.getlayer(ICMPv6EchoReply)
                print("first frag has Echo reply , src: ", packet[IPv6].src, "dst: ", packet[IPv6].dst,"frag id : ", frag.id,"seq: ", icmpv6.seq)
        else:
            if not (frag.offset & htons(0xFFF9)):
...
if __name__ == '__main__':
    ens6_traffic = sniff(iface="enahisic2i3", prn=process_packet)
