...
{
	return test_rte_eal_get_configuration()->master_lcore;
}

unsigned int rte_lcore_count(void)
{
	return test_rte_eal_get_configuration()->lcore_count;
}
...
{
	struct rte_config *cfg = test_rte_eal_get_configuration();
...
rte_eal_cpu_init(void)
{
	...
	struct rte_config *config = test_rte_eal_get_configuration();
	unsigned lcore_id;
	unsigned count = 0;
...
{
	const struct rte_config *config = test_rte_eal_get_configuration();
