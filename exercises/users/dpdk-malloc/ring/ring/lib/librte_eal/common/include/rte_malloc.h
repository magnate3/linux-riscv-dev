 ...
 */
void *
test_rte_malloc(const char *type, size_t size, unsigned align);
 ...
 */
void *
test_rte_calloc(const char *type, size_t num, size_t size, unsigned align);
 ...
 */
void *
test_rte_realloc(void *ptr, size_t size, unsigned int align);
...
__rte_experimental
void *
test_rte_realloc_socket(void *ptr, size_t size, unsigned int align, int socket);
 ...
 */
void *
test_rte_malloc_socket(const char *type, size_t size, unsigned align, int socket);
