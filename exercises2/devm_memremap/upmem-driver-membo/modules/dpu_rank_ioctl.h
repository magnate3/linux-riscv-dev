...
#define DPU_RANK_IOCTL_WRITE_TO_RANK                                           \
	_IOW(DPU_RANK_IOCTL_MAGIC, 0, struct dpu_transfer_mram *)
#define DPU_RANK_IOCTL_READ_FROM_RANK                                          \
	_IOW(DPU_RANK_IOCTL_MAGIC, 1, struct dpu_transfer_mram *)
