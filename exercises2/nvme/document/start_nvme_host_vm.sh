...
# root pass:123456
 qemu-system-x86_64 -enable-kvm -smp 4 -m 8G  -cpu host  -kernel  /work/linux-6.3.2/k_nokaslr/vmlinuz-6.3.2  -append "console=ttyS0 root=/dev/sda1 nokaslr"  -hda  focal-server-rdma.img   -netdev tap,id=tap2,ifname=tap2,script=no,downscript=no,vhost=on  -device virtio-net-pci,netdev=tap2,mac=52:55:00:d2:15:02  -nographic
