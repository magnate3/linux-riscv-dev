...
static int on_connection(struct rdma_cm_id* id)
{
    ...
    do {
	    ...
	    printf(" post send and wait for send cq \n");
	    ...
	    printf(" post recv  and wait for recv cq \n");
