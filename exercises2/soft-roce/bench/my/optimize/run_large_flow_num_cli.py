...
def start_test(small_qp_num, large_qp_num, small_msg_size, large_msg_size):
    ...
    #cmd_list = [
    #    CLT_CMD1 + " > small_result_c1_bw &",
    #    CLT_CMD2 + " > small_result_c2_bw &",
    #    CLT_CMD3 + " > small_result_c3_bw &",
    #    CLT_CMD4 + " > small_result_c4_bw &",
    #    CLT_CMD5 + " > small_result_c5_bw &",
    #]
    for i in range(0,small_qp_parellel):
        ...
        cmd = "{} > logs/small_result_c{}_bw &".format(cmd,i+1)  
        cmd_list.append(cmd)
    for i in range(0,large_qp_parellel):
        ...
        cmd = "{} > logs/large_result_c{}_bw &".format(cmd,i+1+small_qp_parellel)   
        cmd_list.append(cmd)
    for cmd in cmd_list:
        try:
