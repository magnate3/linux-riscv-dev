...
COUNTER_FILE = '/sys/class/infiniband/mlx5_0/ports/1/counters/port_xmit_data'
if FLAGS.dir == "rx":
    COUNTER_FILE = '/sys/class/infiniband/mlx5_0/ports/1/counters/port_rcv_data'
U32_MAX = (1 << 32) - 1
