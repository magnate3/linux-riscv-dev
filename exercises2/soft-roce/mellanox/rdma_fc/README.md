...
```
root@ubuntu:~/rdma/rdma_fc# ./rdma_fc -n 1 -r 32768 -o 8 -i 1000
   rdma_fc.c:1313 INFO  Waiting for 1 connections...
   rdma_fc.c:1272 INFO  Total read bandwidth: 720.42 MB/s
   rdma_fc.c:1014 INFO  Disconnecting 1 connections
root@ubuntu:~/rdma/rdma_fc# 
```
...
```
root@ubuntu:/home/rdma/rdma_fc# ./rdma_fc -n 1 192.168.22.57
   rdma_fc.c:1068 INFO  Connection[0] to 192.168.242.57...
   rdma_fc.c:1014 INFO  Disconnecting 1 connections
root@ubuntu:/home/rdma/rdma_fc# 
```
---
