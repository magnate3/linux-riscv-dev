...
static constexpr uint8_t DEVNAME_SUFFIX_LIST[8] = {1, 0, 0, 0, 0, 0, 0, 0};
...
static constexpr double LINK_BANDWIDTH = 100.0 * 1e9 / 8;  // 100Gbps
...
//static constexpr uint32_t kChunkSize = 2 << 10;
