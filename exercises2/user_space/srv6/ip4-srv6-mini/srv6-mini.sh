...
ip netns exec r1 ip -6 route add fc00:4::bb/128 via 2001:14::2
...
ip netns exec r1 ip route add 10.0.2.0/24 encap seg6 mode encap segs fc00:4::bb dev dev-r1-r4
