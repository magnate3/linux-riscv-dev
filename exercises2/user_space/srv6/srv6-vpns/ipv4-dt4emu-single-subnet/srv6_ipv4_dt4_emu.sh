...
$IPP netns exec r0 $IPP -4 route add 10.0.0.5/32 \
		encap seg6 mode encap segs fc00::2 dev veth2
...
$IPP netns exec r1 $IPP -6 route add fc00::2/128 \
	encap seg6local action End.DX4 nh4 1.1.1.1 dev veth4
# Encap IPv4-in-IPv6
...
$IPP netns exec r1 $IPP -4 rule add to 1.1.1.1 lookup 1111
$IPP netns exec r1 $IPP -4 route add default dev veth4 table 1111
...
$IPP netns exec h1 $IPP addr add 10.0.0.5/24 dev veth5
