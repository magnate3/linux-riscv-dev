...
tcp_addr=["10.0.0.2"]
tcp_weights = []
udp_weights = [3,3,3,3,3,3,3,3]
udp_addr=["10.0.0.2","10.0.0.2","10.0.0.3","10.0.0.3","10.0.0.4","10.0.0.4","10.0.0.4","10.0.0.4"]
dst_addr="10.0.0.1"
...
#SQS table:
# wf_origin_shift = 4      #for now,TCP flow weight origin
wf_origin_shift_list = [1,2,3,4]
time_unit = 3000
...
try:
    ...
    for wf_origin_shift in wf_origin_shift_list:
        wf_origin = 2**wf_origin_shift
        for i in range(0,16):
            if i >= wf_origin:
                break
            low = i*time_unit
