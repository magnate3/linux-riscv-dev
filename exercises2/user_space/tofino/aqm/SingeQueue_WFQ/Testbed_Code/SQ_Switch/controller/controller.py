...
match_table_UDPIndex.info.key_field_annotation_add("hdr.ipv4.srcAddr", "ipv4")
try:
    key_src = "hdr.ipv4.srcAddr"
...
for i in range(0,128):
    ...
    values.append(int(Decimal((1500/R)*(128*1.0/(i+1))).quantize(Decimal("1."), rounding = "ROUND_HALF_UP"))) 
