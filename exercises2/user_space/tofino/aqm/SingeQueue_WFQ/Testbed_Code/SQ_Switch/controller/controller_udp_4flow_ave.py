...
tcp_addr=["10.0.0.3"]
tcp_weights = [3]
udp_weights = [1,2,3,4,4]
udp_addr=["10.0.0.1","10.0.0.4","10.0.0.1","10.0.0.4","10.0.0.4"]
dst_addr="10.0.0.2"
...
try:
    ...
    #最后一个flow，有两个出发点 ，手动写一个 10.0.0.1 9004,index = 5
    match_table_UDPIndex.entry_add(
            target,
            [match_table_UDPIndex.make_key([client.KeyTuple(key_src,"10.0.0.1"),client.KeyTuple(key_dst,9004)])],
            [match_table_UDPIndex.make_data([client.DataTuple("flow_idx",5)],action_name = "SwitchIngress.get_weightindex_UDP")]
        )
finally:
    pass
