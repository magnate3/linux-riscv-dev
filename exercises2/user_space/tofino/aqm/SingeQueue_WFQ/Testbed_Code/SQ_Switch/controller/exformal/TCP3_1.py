...
tcp_addr=["10.0.0.2","10.0.0.2","10.0.0.2","10.0.0.2","10.0.0.3","10.0.0.3","10.0.0.3","10.0.0.3"]
tcp_weights = [3,3,3,3,3,3,3,3]
udp_weights = []
...
try:
    ...
    match_table_forward.entry_add(
        target,
        [match_table_forward.make_key([client.KeyTuple("hdr.ipv4.dst_addr",tcp_addr[5])])],
