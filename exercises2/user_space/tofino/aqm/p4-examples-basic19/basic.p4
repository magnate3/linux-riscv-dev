...
control MyIngress(inout headers hdr,
    ...
    apply {
        if (hdr.ipv4.isValid()) {
            ...
            // IT + Queueing + Admission Control
            // 1. ADD INT header
            process_int.apply(hdr, metadata);
            //log_msg(" INFO Latency : {} ", {hdr.int_header.latency});
            ...
            log_msg(" INFO Class : {} Priority : {} Latency : {} qDelay : {} ", {hdr.int_header.class, standard_metadata.priority, hdr.int_header.latency, metadata.current_queue_delay});
