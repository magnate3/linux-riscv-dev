...
#SBATCH --time=00:02:00  # The maximum duration your job will run in hours:minutes:seconds. It will be automatically killed if it takes longer than that. For your tests, 5-10 minutes should be enough.
