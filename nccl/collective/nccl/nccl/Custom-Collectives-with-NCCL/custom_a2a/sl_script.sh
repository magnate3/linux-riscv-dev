...
#SBATCH --nodes=8  # The number of nodes, you will be currently limited to 1
...
#SBATCH --output=8_out_mpi.out # Name of the output file (whatever your application prints in STDOUT).
