 ...
 *   1   3   5   7   9   11    13
 */
int ncclGetBtree(int nranks, int rank, int* u, int* d0, int* d1, int* parentChildType) {
  int up, down0, down1;
  int bit;
 ...
 */
int ncclGetDtree(int nranks, int rank, int* s0, int* d0_0, int* d0_1, int* parentChildType0, int* s1, int* d1_0, int* d1_1, int* parentChildType1) {
...
int main()
{
    ...
    {
        node = i;
        ncclGetDtree(nNodes, node, &t0u, &t0d0, &t0d1, &t0ChildType, &t1u, &t1d0, &t1d1, &t1ChildType);
        printf("t0u %d , t0d0 %d, t0d1 %d, t0ChildType %d, t1u %d, t1d0 %d , t1d1 %d , t1ChildType %d \n",t0u, t0d0, t0d1, t0ChildType, t1u, t1d0, t1d1, t1ChildType);
    }
#if 0
