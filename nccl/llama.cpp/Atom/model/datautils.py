...
def get_wikitext2(nsamples, seed, seqlen, model, tokenizer):
    ...
    traindata= MsDataset.load('wikitext', subset_name='wikitext-2-v1', split='train')
    testdata= MsDataset.load('wikitext', subset_name='wikitext-2-v1', split='validation')
...
def get_ptb(nsamples, seed, seqlen, model, tokenizer):
    ...
    try:
        ...
        try:
            ...
            traindata = load_dataset('stanfordnlp/ptb', split='train')
            valdata = load_dataset('stanfordnlp/ptb', split='validation')
