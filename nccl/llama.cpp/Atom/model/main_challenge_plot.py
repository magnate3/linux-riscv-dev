...
if __name__ == '__main__':
    ...
    if args.reorder:
        if args.cache_index == False:
            ...
            scales_save_path = f'{args.save_dir}/{model_name}_act_scales_{args.dataset}_{args.act_sort_metric}.pt'
            ...
            if os.path.exists(scales_save_path):
                ...
                torch.save(act_scales, scales_save_path)
            ...
            if os.path.exists(index_filename):
                ...
                torch.save(reorder_index, index_filename)
        else:
            index_filename = f'{args.save_dir}/{model_name}_reorder_index_{args.dataset}.pt'
    ...
    if args.eval_ppl:
        ...
        for dataset in datasets:
            ...
            print(f"targetResult,{dataset},ppl: {ppl:.3f}")
