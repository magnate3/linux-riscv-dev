...
class Worker(WorkerBase):
    ...
    def initialize_from_config(self, kv_cache_config: KVCacheConfig) -> None:
        ...
        #        VLLMModelTracker.register_model("vllm-instance", self.model)
        #    elif hasattr(self, 'model_runner') and hasattr(self.model_runner, 'model'):
        #        VLLMModelTracker.register_model("vllm-instance", self.model_runner.model)
        #except Exception as e:
        #    print(f"[LMCache-Patch] Failed to pre-register model: {e}")
