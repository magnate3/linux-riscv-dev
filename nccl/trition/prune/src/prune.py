...
train_set= TinyImageNet(Path(tinyimagenet_data_dir),split=split,imagenet_idx=False,transform=transform)
print(f"TinyImageNet, split {split}, loading all samples with dataloader:")
split=splits[1]
test_set = TinyImageNet(Path(tinyimagenet_data_dir),split=split,imagenet_idx=False,transform=transform)
print(f"TinyImageNet, split {split}, loading all samples with dataloader:")
