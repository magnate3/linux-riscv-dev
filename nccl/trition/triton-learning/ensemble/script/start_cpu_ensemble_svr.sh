...
#else
#sudo docker run  -it --shm-size=1024m -p8000:8000 -p8001:8001 -p8002:8002 -v ${WORKSPACE}/data/model_repository:/models --name $CONTAINER_NAME nvcr.io/nvidia/tritonserver:24.07-py3  /bin/bash -c \
