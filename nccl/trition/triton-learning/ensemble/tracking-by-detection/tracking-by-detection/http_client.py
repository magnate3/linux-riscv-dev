...
if __name__ == '__main__':
    ...
    #input_image = input_image.permute(0,3, 2, 1)
    input_image = np.transpose(input_image, (0,3, 2, 1))
    # --- 3. Create Triton Input Tensor (using HTTP API) ---
    input_tensor = httpclient.InferInput('input_image', input_image.shape, "UINT8")
