...
#define TEST_PTP 0
#define TEST_PTP_TX 1
#define TEST_MMSL 1
#define TEST_EMAC_DRIVER 0
#define TEST_PMAC_DRIVER 1
#if TEST_MMSL
#define DEFAULT_EMAC_NAME "zero0"
#define  MACB_MMSL_CONTROL 0x0F00
#define  MACB_MMSL_STATUS 0x0F04
#define MACB_PRE_ENABLE_OFFSET 3
...
#define MACB_DMA_CONFIG 0x1010
#define MACB_DMA_ADDR_WD_32B ~(1 << 30) 
...
{
#if TEST_PTP
	pr_info("bp->tstamp_config.rx_filter == TSTAMP_DISABLED: %d", bp->tstamp_config.rx_filter == TSTAMP_DISABLED);
#endif
