 ...
 Dependencies
 #include corenet.h
 #include driversphydp83867_driver.h
 #include debug.h
 ...
 error_t dp83867Init(NetInterface interface)
 {
    ...
    Debug message
    TRACE_INFO(Initializing DP83867...rn);
    ...
    Configure INTNPWDNN pin as an interrupt output
    ...
    Force the TCPIP stack to poll the link state at startup
    interface-phyEvent = TRUE;
    Notify the TCPIP stack of the event
    osSetEvent(&netEvent);
 ...
 void dp83867DumpPhyReg(NetInterface interface)
 {
    ...
    for(i = 0; i  32; i++)
    {
       ...
       TRACE_DEBUG(%02 PRIu8  0x%04 PRIX16 rn, i,
